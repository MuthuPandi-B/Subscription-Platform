...
//         console.log("data",data.paidCourses);
//         if(data.paidCourses){
//           setPaidCourses(prevItems => [...prevItems, {name:"jbj"}]);
//         // setPaidCourses([...paidCourses,data.paidCourses[0]] );
...
//              const checking= await API.post("/auth/add-paid-course", { courseId: course._id, });
//               console.log("After Api call ",checking);
